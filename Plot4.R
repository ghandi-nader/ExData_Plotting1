...
plot(x$Datetime2,x$gap ,type="l",xlab="", ylab="Global Active Power")

plot(x$Datetime2,as.numeric(as.character(x$Voltage)) ,type="l",xlab="datetime", ylab="Voltage")
...
plot(x$Datetime2,as.numeric(as.character(x$Global_reactive_power)) ,type="l",xlab="datetime", ylab="Global_reactive_power")
